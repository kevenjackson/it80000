...
<div class="div7" id="1"><script>$("#1").load("1.php");</script></div>

<div class="div13 width2550"><!-- TemplateBeginEditable name="2" --><!-- TemplateEndEditable --></div>
<div class="div7" id="2"><script>$("#2").load("2.php");</script></div>

<div class="div13 width2550"><!-- TemplateBeginEditable name="3" --><!-- TemplateEndEditable --></div>
<div class="div8" id="3"><script>$("#3").load("3.php");</script></div>

<div class="div13 width2550"><!-- TemplateBeginEditable name="4" --><!-- TemplateEndEditable --></div>
<div class="div7" id="4"><script>$("#4").load("4.php");</script></div>

<div class="div13 width2550"><!-- TemplateBeginEditable name="5" --><!-- TemplateEndEditable --></div>
<div class="div7" id="5"><script>$("#5").load("5.php");</script></div>

<div class="div4 img100" id="14"><script>$("#14").load("/pb/4.php");</script></div>
<div class="div4 img100" id="15"><script>$("#15").load("/pb/5.php");</script></div>
