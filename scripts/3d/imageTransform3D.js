/*HTML5 CANVAS transform Image full 3D version, @author Gerard Ferrandez / http://www.dhteumeuleu.com, last update: Dec 8, 2012*/
...
this.cosZ=1;
this.sinZ=0;
this.target={over: false, elem: false,
x:  0,
y:  0,
z:  0,
rx: 0,
...
ty: (p1.ty + p0.ty) * 0.5};}
/*==== triangulation==== */
ge1doot.transform3D.Image.prototype.triangulate=function (p0, p1, p2, level) {level--;
if (level=== 0) {
// final triangle
...
ge1doot.transform3D.Image.prototype.isPointerInside=function (x, y) {this.drawPoly(this.points); return this.ctx.isPointInPath(x, y);}