 ...
 * skin      --> 皮肤控制
 * durationTime --> 完成时间
 * https://github.com/huanhuan1989  
   http://www.cnblogs.com/huanhuan1989/
*/

;(function($){$.fn.fix = function(options){var defaults={float: 'right', minStatue: false, skin: 'green', durationTime: 100,}
...
/*引用*/
$("#hhService").fix({float: 'right', minStatue: false, skin: 'green', durationTime: 100,});